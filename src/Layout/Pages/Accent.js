...
import blue from "../../Componets/light pictures/blue.JPG"
...
export default function Accent() {
    return (
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-6xl">Accent <span className="text-sky-600">Lighting</span></h2>
