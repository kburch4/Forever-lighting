...
import security2 from "../../Componets/light pictures/security2.jpg";
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-extrabold tracking-tight text-white sm:text-6xl">Security <span className="text-sky-400">Lighting</span></h2>
