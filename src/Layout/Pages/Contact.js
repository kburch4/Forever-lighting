...
export default function Contact() {
    return (
      <div className="bg-slate-900 py-24 sm:py-32">
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-center">
          Contact Us
        </h1>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-2xl">
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-16">
                  <dt className="text-base font-semibold leading-7 text-sky-400">
